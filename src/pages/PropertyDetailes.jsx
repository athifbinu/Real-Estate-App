    ...
    <section>
      <div className="container mx-auto min-h-[800px] mb-14">
        ...
        <div className="flex flex-col items-start gap-8 lg:flex-row">
          ...
          <div
            className="flex-1 bg-slate-100 w-full mb-8 border
          ...
          >
            ...
            <form className="flex flex-col gap-y-4">
              ...
              <textarea
                ...
                placeholder="Message"
                defaultValue="Hello Iam Intrested Modern Apartments"
              ></textarea>
              <div className="flex gap-x-2">
                ...
                <button
                  className="border border-violet-700 hover:border-violet-500
