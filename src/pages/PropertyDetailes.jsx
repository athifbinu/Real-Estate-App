      ...
      <div className="container mx-auto min-h-[800px] mb-14">
           ...
           <div className='flex flex-col items-start gap-8 lg:flex-row'>
            <div className='max-w-[768px]'>
              ...
              <div className='flex gap-x-6 text-violet-7000 mb-6'>
            ...
            <div className='flex-1 bg-slate-100 w-full mb-8 border
             border-gray-300 rounded-lg px-6 py-8'>
              <div className='flex items-center gap-x-4 mb-8'>
                <div className='w-20 h-20 p-1  border-gray-300'>
              ...
              <form className='flex flex-col gap-y-4'>
                <input className='border border-gray-300 focus:border-violet-700
                 outline-none rounded w-full px-4 h-14 text-sm' placeholder='Name' type="text" />
                <input className='border border-gray-300 focus:border-violet-700
                 outline-none rounded w-full px-4 h-14 text-sm' placeholder='Email' type="text" />
                <input className='border border-gray-300 focus:border-violet-700
                 outline-none rounded w-full px-4 h-14 text-sm' placeholder='Phone' type="text" />
                <textarea className='border border-gray-300 focus:border-violet-700
                 ...
                 placeholder='Message' defaultValue="Hello Iam Intrested Modern Apartments">
                ...
                <div className='flex gap-x-2'>
                  ...
                  <button className='border border-violet-700 hover:border-violet-500
